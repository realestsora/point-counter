...
const en = {
    ...
    holdToMoveFab: "Hold to move add button",
    ...
    customAddTitle: "Add points",
    customSubTitle: "Subtract points",
    amount: "Amount",
    applyAdd: "Add {n}",
    applySub: "Subtract {n}",
    holdForCustom: "Hold for custom amount",
    ...
    truncateHistoryNote_one:
        "Also removes 1 newer history item so the timeline stays consistent.",
    truncateHistoryNote_other:
        "Also removes {n} newer history items so the timeline stays consistent.",
    restore: "Restore",
...
const vi: { [K in keyof typeof en]: string } = {
    ...
    duplicateGroup: "Nhân bản nhóm",
    groupCopy: "{name} (bản sao)",
    dragToReorder: "kéo để sắp xếp",
    holdToMoveFab: "Giữ để di chuyển nút thêm",
    ...
    decrease: "Giảm {name}",
    increase: "Tăng {name}",
    customAddTitle: "Cộng điểm",
    customSubTitle: "Trừ điểm",
    amount: "Số điểm",
    applyAdd: "Cộng {n}",
    applySub: "Trừ {n}",
    holdForCustom: "Giữ để nhập số điểm",
    ...
    truncateHistoryNote_one:
        "Đồng thời xóa 1 mục lịch sử mới hơn để timeline không bị lệch.",
    truncateHistoryNote_other:
        "Đồng thời xóa {n} mục lịch sử mới hơn để timeline không bị lệch.",
    restore: "Khôi phục",
